	...
	<div class="row1">
        <div class="row1">
            ...
            <div>
                ...
                <h2>Approval Pending Books</h2>
	
                <div class="grid-container">
                    <?php
                    $sql = "SELECT b.* FROM book b JOIN book_approval_status bas ON b.book_approval_status_id = bas.book_approval_status_id WHERE bas.name = 'PENDING'";
                    $result = $conn->query($sql);
                            ...
                            <div class="grid-item">
                                <div class="bookf">
                                    ...
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                                        ...
                                        <button type="submit" class="adCart">Submit</button>
                                    </form>
                                </div>
                            </div>
                            <?php
                    ...
                    {
                        ?>
                        <div class="status-msg">No books in approval pending state.</div>
                        <?php
                    }
                    ?>
                </div>
